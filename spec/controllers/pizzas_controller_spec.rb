  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved pizza as @pizza" do
        ...
        post :create, {:pizza => { "name" => "invalid value" }}, valid_session
        assigns(:pizza).should be_a_new(Pizza)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested pizza" do
        ...
        Pizza.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => pizza.to_param, :pizza => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the pizza as @pizza" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Pizza.any_instance.stub(:save).and_return(false)
        put :update, {:id => pizza.to_param, :pizza => { "name" => "invalid value" }}, valid_session
        assigns(:pizza).should eq(pizza)
      end
